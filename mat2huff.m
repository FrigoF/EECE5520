...
%
% If X is logical, uintS, uintl6, uint32, intS, intl6, or double, with
% integer values, it can be input directly to MAT2HUFF. The minimum
% value of X must be representable as an int16.
%
% If X is double with non-integer values---for example, an image withvalues between 0 and l---first scale X to an appropriate integer
...
% See also HUFF2MAT.
%
% See Digital Image Processing with MATLAB, 3rd edition, page 532
...
% binsj scale to UINT16, and store,
x = x(:)';
