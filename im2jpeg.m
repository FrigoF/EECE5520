...
%IM2DPEG Compresses an image using JPEG approximation.
...
%
% See also JPEG2IM.
% See Digital Image Processing with MATLAB, 3rd edition, page 552
% BUGS:  Input image size of 512x512 works OK, but other image sizes may fail.
...
%JPEG normalizing array and zig-zig reordering pattern
...
for j = 1:xb                    % Process 1 block (col) at a time
   ...
   p = count + 1;
   q = p + i;
   r(p:q) = [y(1:i,j); eob];     % Truncate trailing Q ’ s , add EOB,
