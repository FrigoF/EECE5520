...
% Coherent noise filter - zero out the 2 noise points
H3=ones(yres, xres);
H3(C1(2),C1(1)) = 0.0;
H3(C2(2),C2(1)) = 0.0;
...
% Apply the filter to remove the coherent noise
SF = S.*H3;
F1 = fftshift(SF);
...
title("Filtered image using Coherent Noise filter");drawnow;
